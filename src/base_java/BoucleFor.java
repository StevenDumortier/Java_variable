...
//        System.out.println("Entrer le nombre que vous voulez connaitre la table de multiplication : ");
//        int nombre = table.nextInt();
//        for(int i = 0;i<=12;i++)
//        {
//            System.out.println(nombre+" x " + i + " = " + (i*nombre));
//            // System.out.printf("%d x %d = %d\n",nombre,i,(nombre*i));
//        }
//        // table de multiplication version 2
...
//        var nombre2=table.nextInt();
//        System.out.print("Debut : ");
//        var nombreDebut=table.nextInt();
//
//        System.out.print("Fin : ");
//        var nombreFin=table.nextInt();
//
//
