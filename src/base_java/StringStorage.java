...
public class StringStorage {
    public static void main(String[] args) {
        ...
        // Ce Poo.test.test va être évalué a false
        ...
        System.out.println("Poo.test.test avant d'ajouter nom3 dans le pool");
        nom3 = nom3.intern();
        if (nom == nom3)
        {
            System.out.println("nom pointe vers le même string que nom3");
        ...
        System.out.println("Poo.test.test après d'ajouter nom3 dans le pool");
    }
}
